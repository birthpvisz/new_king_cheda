...
import com.example.kingcheda.Model.Cart;
import com.example.kingcheda.Prevalent.Prevalent;
import com.example.kingcheda.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            {
                txtTotalAmount.setText("Total Price = " + String.valueOf(overTotalPrice) + " KSH");
