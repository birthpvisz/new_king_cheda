...
import com.example.kingcheda.Admin.AdminMaintainProductActivity;
import com.example.kingcheda.CartActivity;
...
import com.example.kingcheda.ProductDetailsActivity;
import com.example.kingcheda.R;
import com.example.kingcheda.SearchProductsActivity;
import com.example.kingcheda.SettingsActivity;
import com.example.kingcheda.ViewHolder.ProductViewHolder;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (!type.equals("Admin"))
        {
            ...
            Picasso.get().load(Prevalent.currentOnlineUser.getImage()).placeholder(R.drawable.home_profile).into(profileImageView);
        }
